...
export default function Audio() {
    this.icons = [
        ...
        new Icon(8, require('../../resources/textures/pausebutton.png'), new THREE.Vector3(-0.5, -0.2, 0)),
        // new Icon(10, require("../../resources/circle.png")),
        new Icon(5, require('../../resources/textures/nextbutton.png'), new THREE.Vector3(8, 0, 0)),
        new Icon(5, require('../../resources/textures/previousbutton.png'), new THREE.Vector3(-8, 0, 0)),
    ];
...
Audio.prototype.playAudio = function () {
    ...
    if (!this.isPlaying) this.icons[1].mesh.position.z += 2;
